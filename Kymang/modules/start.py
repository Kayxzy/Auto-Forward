...
Saya Dibuat Untuk Memudahkan Anda Mengelola Channel Yang Menggunakan Fitur Wajib Join.

Jika Kamu Sudah Melakukan Pembayaran, Silakan Klik Deploy Fsub . 

Jika Kamu Tidak Mengerti, Kamu Bisa Melihat Tutorial Yang Sudah Kami Sediakan .

Atau Kamu Bisa Menghubungi Admin Jika Memiliki Pertanyaan .
...
buttons2 = [
    [
        InlineKeyboardButton("Deploy Fsub", callback_data="buat_bot"),
    ],
    [
    ...
    [
        InlineKeyboardButton("Kontak Admins", callback_data="cb_admines"),
    ],
    [
